<p align="center">
  ...
  <img src="https://img.shields.io/badge/vulnerabilities-41-red" alt="41 Vulnerabilities">
...
📆 2026-07-15 &nbsp;|&nbsp; 🐧 Kali Linux + 🐍 Flask 3.1 + 🕵️ Burp Suite CE
...
从零开始构建一个 Flask 用户管理系统，每轮新增功能后进行**完整的安全审计与加固**。涵盖密码安全、SQL注入、文件上传、业务逻辑、文件包含、CSRF、SSRF 七大安全类别。
